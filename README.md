...
| | | | | |
|:---:|:---:|:---:|:---:|:---:|
| **Balkendiagramm**<br>![Bar Chart](screenshots/Diagrams/chart-bar.png)<br><small>Klassische Wertevergleiche mit horizontaler/vertikaler Orientierung</small> | **Gestapeltes Balkendiagramm**<br>![Stacked Bar](screenshots/Diagrams/chart-stackedBar.png)<br><small>Mehrere Datensätze übereinander mit Prozentanzeige-Option</small> | **Gruppiertes Balkendiagramm**<br>![Grouped Bar](screenshots/Diagrams/chart-groupedBar.png)<br><small>Mehrere Datensätze nebeneinander für direkten Vergleich</small> | **Radiales Balkendiagramm**<br>![Radial Bar](screenshots/Diagrams/chart-radialBar.png)<br><small>Kreisförmige Anordnung von Balken</small> | **Liniendiagramm**<br>![Line Chart](screenshots/Diagrams/chart-line.png)<br><small>Trends und Zeitreihen mit horizontaler/vertikaler Orientierung</small> |
| **Flächendiagramm**<br>![Area Chart](screenshots/Diagrams/chart-area.png)<br><small>Gefüllte Linie für Volumen-Darstellung</small> | **Multi-Liniendiagramm**<br>![Multi-Line](screenshots/Diagrams/chart-multiLine.png)<br><small>Mehrere Linien zum Vergleich verschiedener Datensätze</small> | **Treppenstufen-Liniendiagramm**<br>![Stepped Line](screenshots/Diagrams/chart-steppedLine.png)<br><small>Gestufte Verläufe für diskrete Änderungen</small> | **Gestricheltes Liniendiagramm**<br>![Dashed Line](screenshots/Diagrams/chart-dashedLine.png)<br><small>Gestrichelte Linien für alternative Darstellung</small> | **Stream-Graph**<br>![Stream Graph](screenshots/Diagrams/chart-streamGraph.png)<br><small>Gestapeltes Flächendiagramm mit zentrierter Basislinie</small> |
| **Kreisdiagramm**<br>![Pie Chart](screenshots/Diagrams/chart-pie.png)<br><small>Anteile und Verhältnisse mit Donut/Halbkreis-Optionen</small> | **Polar-Flächendiagramm**<br>![Polar Area](screenshots/Diagrams/chart-polarArea.png)<br><small>Kreisförmige Flächendarstellung kategorialer Werte</small> | **Verschachteltes Donut**<br>![Nested Donut](screenshots/Diagrams/chart-nestedDonut.png)<br><small>Mehrere Donuts übereinander für hierarchische Daten</small> | **Streudiagramm**<br>![Scatter](screenshots/Diagrams/chart-scatter.png)<br><small>Korrelationen zwischen zwei Variablen, unterstützt geografische Koordinaten</small> | **Blasendiagramm**<br>![Bubble](screenshots/Diagrams/chart-bubble.png)<br><small>3-dimensionale Daten mit Radius, Optionen für feste Größe</small> |
| **Heatmap-Diagramm**<br>![Heatmap](screenshots/Diagrams/chart-heatmap.png)<br><small>Matrix mit Farbintensitäten, Standard- und Kalender-Heatmap</small> | **Radar-Chart**<br>![Radar](screenshots/Diagrams/chart-radar.png)<br><small>Mehrdimensionale Daten auf polaren Achsen</small> | **Kombiniertes Diagramm**<br>![Mixed](screenshots/Diagrams/chart-mixed.png)<br><small>Verschiedene Charttypen kombiniert in einem Diagramm</small> | **Candlestick-Diagramm**<br>![Candlestick](screenshots/Diagrams/chart-candlestick.png)<br><small>Finanzdaten-Visualisierung mit Open/High/Low/Close</small> | **OHLC-Diagramm**<br>![OHLC](screenshots/Diagrams/chart-ohlc.png)<br><small>Open-High-Low-Close Darstellung für Finanzdaten</small> |
| **Box-Plot**<br>![Box Plot](screenshots/Diagrams/chart-boxPlot.png)<br><small>Statistische Verteilungsanalyse mit Quartilen</small> | **Violin-Plot**<br>![Violin Plot](screenshots/Diagrams/chart-violinPlot.png)<br><small>Kombination aus Box-Plot und Dichteverteilung</small> | **Funnel-Diagramm**<br>![Funnel](screenshots/Diagrams/chart-funnel.png)<br><small>Trichterdarstellung für Prozess-Visualisierung</small> | **Choropleth-Karte**<br>![Choropleth](screenshots/Diagrams/chart-choropleth.png)<br><small>Geografische Datenvisualisierung auf Karten</small> | **Venn-Diagramm**<br>![Venn](screenshots/Diagrams/chart-venn.png)<br><small>Mengendiagramm zur Darstellung von Überschneidungen</small> |
